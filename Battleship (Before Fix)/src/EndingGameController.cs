...
public static class EndingGameController
{
    ...
    ///<summary>
    ///DrawEndOfGame draws the end of the game screen, shows the win/lose stats.
    /// </summary>
    ...
    ///<summary>
    ///HandleEndOfGameInput handles the input during the end of the game. Any interaction
    ///will result in it reading the highSwinGame.
    /// </summary>
